...
export class Config {
  constructor() {
    ...
    this.control.instruments = aux.instruments ?? { 'fue': true, 'hyoshigi': true, 'chanpon': true, 'surigane': true, 'taiko': true, 'kotsuzumi': true, 'koto': true }
    this.control.languages = aux.languages ?? { 'japanese': true, 'romaji': true, 'english': true, 'chinese': true, 'french': true, 'korean': true, 'portuguese': true, 'spanish': true }
...
// a classe Config e Link dependem da variável config
window.config
