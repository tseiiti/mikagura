...
export const HYMN_00 = {
  ...
  paragraphs: [
    [ {
      ...
      phrase:     'namu xtenri o no mikoto',
      japanese:   'なむてんりわうのみこと (よしよし)',
      romaji:     'namu tenri-ō-no-mikoto. (yoshi yoshi)',
      english:    'Namu Tenri-Ō-no-Mikoto (Good good)',
      chinese:    '南無天理羽命 (好 好)',
      french:     'Namu Tenri-Ô-no-Mikoto (Bien bien)',
      korean:     '나무 텐 리와 만 (요시요시)',
      portuguese: 'Namu Tenri-Ō-no-Mikoto (Bom bom)',
      spanish:    'Namu Tenri-Ō-no-Mikoto (Bien bien)',
      hyoshigi:   '1   1   1   1   1',
      chanpon:    '  1   1   1   1',
      surigane:   '1 221 221 221 221',
      taiko:      '1   1   1     2 1',
